...
class Semester(models.Model):
    ...
    def get_absolute_url(self):
        return reverse(
            'courseinfo_semester_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_semester_update_urlpattern',
            kwargs={'pk':self.pk}
        )
...
class Course(models.Model):
    ...
    course_name = models.CharField(max_length=455)
    ...
    def get_absolute_url(self):
        return reverse(
            'courseinfo_course_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_course_update_urlpattern',
            kwargs={'pk':self.pk}
        )
...
class Instructor(models.Model):
    ...
    def get_absolute_url(self):
        return reverse(
            'courseinfo_instructor_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_instructor_update_urlpattern',
            kwargs={'pk':self.pk}
        )
...
class Student(models.Model):
    ...
    def get_absolute_url(self):
        return reverse(
            'courseinfo_student_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_student_update_urlpattern',
            kwargs={'pk':self.pk}
        )
...
class Section(models.Model):
    ...
    class Meta:
        ordering = ['course__course_number', 'section_name', 'semester__year', 'semester__period',
                    'instructor__last_name']
        unique_together = (('semester', 'course', 'section_name'),)

    def get_absolute_url(self):
        return reverse(
            'courseinfo_section_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_section_update_urlpattern',
            kwargs={'pk':self.pk}
        )
...
class Registration(models.Model):
    ...
    def get_absolute_url(self):
        return reverse(
            'courseinfo_registration_detail_urlpattern',
            kwargs={'pk': self.pk}
        )

    def get_update_url(self):
        return reverse(
            'courseinfo_registration_update_urlpattern',
            kwargs={'pk':self.pk}
        )
